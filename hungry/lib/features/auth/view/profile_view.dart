            ...
            child: Column(
              children: [
                ...
                ListTile(
                  ...
                  title: custom_text(text: 'Debit card',color: Colors.black),
                  subtitle: custom_text(text: '**** ***** 2342',color: Colors.black),
                  trailing: custom_text(text: 'Default',color: Colors.black),
                ),
                Gap(400),
              ],
            ),
            ...
            child: Row(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      custom_text(text: 'Edit Profile', fontWeight: FontWeight.bold, color: Colors.white),
                      Gap(5),
                ...
                Container(
                    ...
                    child: Row(
                      children: [
                        custom_text(text: 'Logout', fontWeight: FontWeight.bold, color: AppColors.primary),
                        Gap(5),
